...
@allure.label("owner", "Aruzhan")
@allure.feature("Регистрация DemoQA")
@allure.story("Пользователь может заполнить форму регистрации")
...
def test_submit_student_registration_form():
    ...
    # THEN
    with allure.step("Проверяем данные регистрации"):
